...
[Quick Start](/docs/quick-start) [Principles](/docs/principles) [Models](/docs/models) [Provider Routing](/docs/provider-routing) [Model Routing](/docs/model-routing) [OAuth PKCE](/docs/oauth) [API Keys](/docs/api-keys) [Crypto APInew](/docs/crypto-api) [Requests](/docs/requests) [Responses](/docs/responses) [Parameters](/docs/parameters) [Structured Outputs](/docs/structured-outputs) [Parameters API](/docs/parameters-api) [Prompt Caching](/docs/prompt-caching) [Transforms](/docs/transforms) [Errors](/docs/errors) [Limits](/docs/limits) [Integrationsnew](/docs/integrations) [Frameworks](/docs/frameworks) [Uptime](/docs/uptime)
...
[Crypto Payments API](/docs/crypto-api) [Responses](/docs/responses)